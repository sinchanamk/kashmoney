...
class SelectMenuTextFormField extends StatelessWidget {
 ...
 final TextEditingController textEditingController;
   const SelectMenuTextFormField({ Key? key, required this.hintText,required this.textEditingController,required this.fun }) : super(key: key);
...
// Widget selectMenuTextFormField(
//   String hintText,
//   BuildContext context,
//   TextEditingController textEditingController,
// ) {
...
//             hintStyle: CommonStyles.textField16w500primary(),
//             filled: false,
//             contentPadding:
//                 const EdgeInsets.only(left: 14.0, bottom: 6.0, top: 8.0),
//             enabledBorder: const UnderlineInputBorder(
